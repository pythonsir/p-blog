...
global $site_layout;
$site_layout = array(
	'side-pull-left'  => esc_html__( '右侧边栏', 'sparkling' ),
	'side-pull-right' => esc_html__( '左侧边栏', 'sparkling' ),
	'no-sidebar'      => esc_html__( '没有侧边栏', 'sparkling' ),
	'full-width'      => esc_html__( '全宽度', 'sparkling' ),
);
