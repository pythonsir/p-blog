...
function sparkling_footer_info() {
	...
	printf( esc_html__( 'Theme by %1$s Powered by %2$s', 'sparkling' ), '<a href="https://colorlib.cn/" target="_blank">Colorlib</a>', '<a href="http://wordpress.org/" target="_blank">WordPress</a>' );
}
